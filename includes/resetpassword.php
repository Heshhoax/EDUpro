...
if ($result->num_rows > 0) {
    ...
    echo "<form action='updateuserbyuser.php' method='post'>";
    ...
    echo "<input type='text' name='pass' value='".$userdata['pwd']."' style='width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; box-sizing: border-box;'>";
    echo "</div>";
